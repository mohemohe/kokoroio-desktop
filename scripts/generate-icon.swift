...
// kokoro.io's theme color (#564ec2) and a darker shade from its official logo.
// https://kokoro.io/manifest.webmanifest
// https://kokoro.io/images/kokoroio_lower.svg
let kokoroBlue = NSColor(srgbRed: 86.0 / 255, green: 78.0 / 255, blue: 194.0 / 255, alpha: 1)
let kokoroDarkBlue = NSColor(srgbRed: 55.0 / 255, green: 57.0 / 255, blue: 192.0 / 255, alpha: 1)
...
func makeIcon(pixels: Int, filename: String) throws {
    ...
    let gradient = NSGradient(starting: kokoroBlue, ending: kokoroDarkBlue)!
